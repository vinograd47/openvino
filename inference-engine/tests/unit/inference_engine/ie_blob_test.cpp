...
TEST_F(BlobTests, readRoiBlob) {
    ...
    const auto roi = InferenceEngine::TensorSlice {
        InferenceEngine::DimSlice {0, 1},
        InferenceEngine::DimSlice {0, 3},
        InferenceEngine::DimSlice {2, 2},
        InferenceEngine::DimSlice {4, 4}
    };
